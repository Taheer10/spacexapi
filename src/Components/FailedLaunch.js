...
import { FailSingleBody } from "./FailSingleBody";
...
const BodySection = () => {
  ...
  const Api_url = "https://api.spacexdata.com/v3/launches?limit=100&launch_success=false";
    ...
    <div className="container">
      ...
      {posts?.length > 0 ? (
        <div className="contents-section">
           {posts.map((object) => (
            <FailSingleBody key={object.flight_number} object={object} />
          ))}
          {/* {posts.map((object) => (
